...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/photo-camera.svg
  String get photoCamera => 'assets/icons/photo-camera.svg';

  /// List of all assets
  List<String> get values => [cube, menu, photoCamera];
}

class Assets {
  Assets._();

  static const AssetGenImage bannerMin = AssetGenImage('assets/banner-min.jpg');
  static const AssetGenImage certificationMin =
      AssetGenImage('assets/certification-min.png');
